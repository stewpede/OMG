...
<div>
        ...
        <div  style="min-height: 500px;background-color:#C0C0C0">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="color: green;" align="center" class="page-header">VERIFIED REPORTS<br><br><a type="button" href="../menu/home.php" name="home" class="btn btn-primary">BACK TO HOME</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" id="logs">
                                        ...
                                        <tbody>
                                            <!-- <tr  role="row"> -->
                                                <?php 
                                                $query = "SELECT * FROM reports WHERE status_report = '1' AND verification = 'VERIFIED'";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <!-- <a href="../menu/reservation_view.php?view_acc_reservation=<?php echo $row['order_by']; ?>" class="btn btn-info"><i class="fas fa-user"> VIEW REPORT</i></a> -->
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                        </tbody>
