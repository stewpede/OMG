...
<div>
        ...
        <div  style="min-height: 500px;background-color:#C0C0C0">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="color: green;" align="center" class="page-header">PENDING REPORTS<br><br><a type="button" href="../menu/home.php" name="home" class="btn btn-primary">BACK TO HOME</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <div class="modal-dialog">
             <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="unverify" id="unverify" class="btn btn-danger" value="UNVERIFY"/>
     ...
     $(document).ready(function(){
        $('#logs').on('click', '.view_data',function(){
            ...
            $(document).on('click','#unverify',function(){ 
                 var unverify_id = report_id;
                $.ajax({
                   
                    url:"../server.php",
                    method:"get",
                    data:{unverify_id:unverify_id},
                    success:function(data)
                    {
                        //alert("Sucess");
                        console.log(unverify_id);
