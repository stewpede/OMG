...
<div>
        ...
        <div  style="min-height: 500px;background-color:#C0C0C0">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="color: green;" align="center" class="page-header">LIST OF DRIVERS<br><br><a type="button" href="../menu/home.php" name="home" class="btn btn-primary">BACK TO HOME</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
